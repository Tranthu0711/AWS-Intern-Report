...
- **Tools:** 
<br>&emsp; - AWS Management Console (main interface for resource configuration) 
<br>&emsp; - SSH client (Git Bash / Terminal) to connect to EC2 instance 
<br>&emsp; - SCP (Secure Copy Protocol) to transfer source code from local machine to server 
<br>&emsp; - Composer to install AWS SDK for PHP (used for S3 integration) 
- **IAM Permissions:** The following permissions are required: 
<br>&emsp; - Amazon EC2 Full Access 
<br>&emsp; - Amazon RDS Full Access 
<br>&emsp; - Amazon S3 Full Access 
<br>&emsp; - IAM permission to create Access Keys 
